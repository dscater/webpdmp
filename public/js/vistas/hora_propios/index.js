    ...
    if (validaDatosRegistros())
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response != 'NO TIENES NINGÚN EQUIPO/MAQUINARIA DE TIPO PROPIO ASIGNADO') {
...
function getForm(accion = 'nuevo', hora_propio_id = null, dia_seleccionado = null) {
    $.ajax({
        type: "GET",
