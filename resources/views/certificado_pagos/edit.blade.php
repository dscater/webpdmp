...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right bg-white">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('certificado_pagos.index') }}">Certificado de Pagos</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    {{ Form::model($certificado_pago, ['route' => ['certificado_pagos.update', $certificado_pago->id], 'method' => 'put', 'files' => true]) }}
