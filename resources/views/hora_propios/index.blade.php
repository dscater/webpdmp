...
@section('css')
<link rel="stylesheet" href="{{asset('css/vistas/hora_propios/index.css')}}">
@endsection
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Administrar Partes Diarios y Control de Horas Trabajadas (PROPIOS)</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Inicio</a></li>
                    <li class="breadcrumb-item active">Administrar Partes Diarios y Control de Horas Trabajadas (PROPIOS)</li>
                </ol>
            </div>
        </div>
    </div>
...
@include('modal.horas')
<input type="hidden" value="{{route('hora_propios.getRegistros')}}" id="urlGetRegistros">
<input type="hidden" value="{{route('hora_propios.getFormulario')}}" id="urlGetFormulario">
@endsection
@section('scripts')
<script src="{{asset('js/vistas/hora_propios/index.js')}}"></script>
