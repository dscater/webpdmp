<div class="modal fade" id="m_maquinarias">
    <div class="modal-dialog">
        <div class="modal-content  bg-sucess">
            <div class="modal-header">
                <h4 class="modal-title">Lista de Maquinarias o Equipos</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'reportes.maquinarias', 'method' => 'get', 'target' => '_blank', 'id' => 'formMaquinarias']) !!}
                <div class="row">
                    <div class="col-md-12">
